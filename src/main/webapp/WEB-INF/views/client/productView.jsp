...
<head>
  ...
  <script src="${pageContext.request.contextPath}/js/productt.js" type="module"></script>
</head>
                  ...
                  <form action="${pageContext.request.contextPath}/deleteProductReview"
                    ...
                    <div class="btn-group" role="group">
                      <a href="${pageContext.request.contextPath}/editProductReview?id=${productReview.id}"
                         ...
                         onclick="return confirm('Bạn có muốn sửa ?')">
                        Sửa
                      </a>
            ...
            <div class="ratting-form-wrapper">
              <div class="ratting-form">
                <form action="${pageContext.request.contextPath}/addProductReview" method="post">
                  ...
                  <input type="hidden" name="productId" value="${requestScope.product.id}">
                  <button type="submit" class="btn btn-primary" onclick="return confirm('Bạn muốn gửi đánh giá ?')">Gửi đánh giá</button>
                </form>
              </div>
            </div>
          </c:when>
