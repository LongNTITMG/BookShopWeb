...
<section class="section-content mx-auto" style="margin: 100px 0; max-width: 380px;">
  <h3 class="mb-3 p-3 text-center bg-primary text-white rounded">Book Shop</h3>
  <div class="card">
    <div class="card-body">
      ...
      <form action="${pageContext.request.contextPath}/admin/signin" method="post">
        ...
        <button type="submit" class="btn btn-primary w-100" onclick="return confirm('Bạn muốn đăng nhập ?')">Đăng nhập</button>
      </form>
    </div> <!-- card-body.// -->
  </div> <!-- card .// -->
