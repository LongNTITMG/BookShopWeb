...
public class ProductService extends Service<Product, ProductDAO> implements ProductDAO {
    ...
    public Optional<Product> getByName(String name) {
        return jdbi.withExtension(ProductDAO.class, dao -> dao.getByName(name));
    }
    
    @Override
    public Optional<Product> getByAuthor(String author) {
        return jdbi.withExtension(ProductDAO.class, dao -> dao.getByAuthor(author));
    }
}
