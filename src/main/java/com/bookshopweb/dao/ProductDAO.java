...
public interface ProductDAO extends DAO<Product> {
    ...
    Optional<Product> getByName(@Bind("name") String name);
    
    @SqlQuery("SELECT * FROM product WHERE author = :author")
    Optional<Product> getByAuthor(@Bind("author") String author);
}
