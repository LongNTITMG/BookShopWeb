...
public class UpdateProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (productFromServer.isPresent()) {
            ...
            request.getRequestDispatcher("/WEB-INF/views/admin/updateProductView.jsp").forward(request, response);
        } else {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Optional<Product> productServer1 = Protector.of(() -> productService.getByName(request.getParameter("name")))
                .get(Optional::empty);
        
        Optional<Product> productServer2 = Protector.of(() -> productService.getByAuthor(request.getParameter("author")))
        		.get(Optional::empty);
        ...
        violations.put("nameViolations", Validator.of(product.getName())
                ...
                .isNotExistent(productServer1.isPresent(), "Tên sản phẩm")
                .toList());
        ...
        violations.put("authorViolations", Validator.of(product.getAuthor())
                ...
                .isNotBlankAtBothEnds()
                .isAtMostOfLength(50)
                .isNotExistent(productServer2.isPresent(), "Tên tác giả")
                .toList());
